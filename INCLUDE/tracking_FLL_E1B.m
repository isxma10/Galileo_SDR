function [trackResults, channel]= tracking_FLL_E1B(fid, channel, settings)
...
for channelNr = 1:settings.numberOfChannels
    ...
    if (channel(channelNr).PRN ~= 0)
        ...
        E1BCode = generateE1Bcode2_1(channel(channelNr).PRN,1);
        % Then make it possible to do early and late versions
        E1BCode = [E1BCode(end-3) E1BCode(end-2) E1BCode(end-1) E1BCode(end) E1BCode E1BCode(1) E1BCode(2) E1BCode(3) E1BCode(4)];
